...
/**
 * Seed permission report.vehicle.export (UC-128, Bước 5 SAVP).
 * Gán cho 3 role: MANAGER, BUSINESS_ADMIN, SYSTEM_ADMIN.
 */
export class SeedReportVehicleExportPermission20260723000012 implements MigrationInterface {
  name = 'SeedReportVehicleExportPermission20260723000012';

  private readonly permission = {
    code: 'report.vehicle.export',
    name: 'Xuat bao cao phuong tien',
    action: 'vehicle.export',
    description:
      'Cho phep tao job xuat bao cao phuong tien (danh sach dang ky / thong ke luu luong / ca hai) ra PDF hoac XLSX va tai file qua background job',
  };
