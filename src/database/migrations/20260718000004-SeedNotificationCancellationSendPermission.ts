...
/**
 * Seed permission notification.cancellation.send (Cho phep gui lai thong bao huy cuoc hop (UC-145)).
 * Roles: EMPLOYEE, MANAGER, BUSINESS_ADMIN, SYSTEM_ADMIN.
 * KHONG dung role INTERNAL_USER (role nay khong ton tai trong DB).
 */
export class SeedNotificationCancellationSendPermission20260718000004 implements MigrationInterface {
  name = 'SeedNotificationCancellationSendPermission20260718000004';

  private readonly permission = {
    code: 'notification.cancellation.send',
    name: 'Gui lai thong bao huy hop',
    action: 'cancellation.send',
    description: 'Cho phep gui lai thong bao huy cuoc hop (UC-145)',
  };
