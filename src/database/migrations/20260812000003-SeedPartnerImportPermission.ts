...
export class SeedPartnerImportPermission20260812000003 implements MigrationInterface {
  name = 'SeedPartnerImportPermission20260812000003';

  private readonly permission = {
    code: 'account.partner.import',
    name: 'Import Excel tài khoản đối tác',
    action: 'partner.import',
    description:
      'Cho phép nạp hàng loạt tài khoản đối tác/khách hàng tạm thời từ tệp Excel',
  };
