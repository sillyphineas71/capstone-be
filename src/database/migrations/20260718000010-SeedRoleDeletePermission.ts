...
/**
 * Seed permission account.role.delete (Role Management - Xoa role).
 * Roles: SYSTEM_ADMIN.
 */
export class SeedRoleDeletePermission20260718000010 implements MigrationInterface {
  name = 'SeedRoleDeletePermission20260718000010';

  private readonly permission = {
    code: 'account.role.delete',
    name: 'Xoa role',
    action: 'delete',
    description: 'Cho phep xoa role trong module accounts',
  };
