...
/**
 * Seed permission analytics.room.read (UC-AA-02 / UC-149).
 * Dùng migration vì migration là cơ chế seed duy nhất thực sự chạy được.
 */
export class SeedAnalyticsRoomReadPermission20260702070000 implements MigrationInterface {
  name = 'SeedAnalyticsRoomReadPermission20260702070000';
