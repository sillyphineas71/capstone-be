...
/**
 * Seed permission account.role.update (Role Management - Cap nhat role).
 * Roles: SYSTEM_ADMIN.
 */
export class SeedRoleUpdatePermission20260718000009 implements MigrationInterface {
  name = 'SeedRoleUpdatePermission20260718000009';

  private readonly permission = {
    code: 'account.role.update',
    name: 'Cap nhat role',
    action: 'update',
    description: 'Cho phep cap nhat role trong module accounts',
  };
