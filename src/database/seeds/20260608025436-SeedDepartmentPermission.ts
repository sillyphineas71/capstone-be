 ...
 */
export async function seedDepartmentPermission(dataSource: DataSource): Promise<void> {
...
async function assignPermissionToRoles(queryRunner: any, permissionId: string): Promise<void> {
