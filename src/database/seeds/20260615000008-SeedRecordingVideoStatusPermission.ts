...
/**
 * Seed permission cho REC-004 (Xem trạng thái ghi hình).
 * Bám convention seed hiện có. (seed-runner chưa wire — vấn đề team-wide.)
 */
export async function seedRecordingVideoStatusPermission(
  ...
  try {
    const permissionResult = await queryRunner.query(
      ...
      [
        ...
        'Xem trạng thái ghi hình',
        'recording',
        'video_status',
        'Cho phép xem trạng thái phiên ghi hình (live duration/size, trạng thái).',
      ],
    );
