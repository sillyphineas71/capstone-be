...
export async function seedMeetingExtensionRequestPermission(
  ...
  try {
    const permissionCode = 'meeting.extension.request.own';
    const permissionName = 'Yêu cầu gia hạn phiên họp';
    const moduleCode = 'live-meeting';
    const actionCode = 'extension.request.own';
    const description = 'Cho phép yêu cầu gia hạn phiên họp đang diễn ra';
