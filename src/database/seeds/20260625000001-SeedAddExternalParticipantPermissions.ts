...
export async function seedAddExternalParticipantPermissions(
  ...
  try {
    const permissionResult = await queryRunner.query(
      ...
      [
        ...
        'Thêm khách mời bên ngoài cuộc họp',
        'meetings',
        'participant_add_external',
        'Cho phép thêm khách mời bên ngoài vào cuộc họp',
      ],
    );
