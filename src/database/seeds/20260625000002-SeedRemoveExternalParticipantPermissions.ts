...
export async function seedRemoveExternalParticipantPermissions(
  ...
  try {
    const permissionResult = await queryRunner.query(
      ...
      [
        ...
        'Gỡ bỏ khách mời bên ngoài cuộc họp',
        'meetings',
        'participant_remove_external',
        'Cho phép gỡ khách mời bên ngoài khỏi cuộc họp',
      ],
    );
