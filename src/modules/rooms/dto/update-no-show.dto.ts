...
export class UpdateNoShowDto {
  @ApiPropertyOptional({ description: 'Trạng thái phát hiện mới (service tự validate transition hợp lệ)' })
  @IsOptional()
  @IsString()
  detectionStatus?: string;

  @ApiPropertyOptional({ description: 'Kết luận xử lý case', enum: ['kept', 'false_positive', 'manual_override'] })
  @IsOptional()
