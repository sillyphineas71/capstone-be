import { BiometricStatusRawRepository } from './biometric-status-raw.repository';

/**
 * ACCT-BIOMETRIC-SUBMIT-001 — Unit test cho BiometricStatusRawRepository (SB-01).
 */
describe('BiometricStatusRawRepository', () => {
  let repo: BiometricStatusRawRepository;
  let dataSource: { query: jest.Mock };

  beforeEach(() => {
    dataSource = { query: jest.fn() };
    repo = new BiometricStatusRawRepository(dataSource as never);
  });
