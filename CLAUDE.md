...
This project is indexed by GitNexus as **capstone-be** (46279 symbols, 80160 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/capstone-be/context` | Codebase overview, check index freshness |
| `gitnexus://repo/capstone-be/clusters` | All functional areas |
| `gitnexus://repo/capstone-be/processes` | All execution flows |
| `gitnexus://repo/capstone-be/process/{name}` | Step-by-step execution trace |
